class ServiceOrderPdfGenerator
  ...
  def add_order_info
    @pdf.text "INFORMAÇÕES DA ORDEM", size: 11, style: :bold
    @pdf.move_down 5
  ...
  def add_customer_info
    ...
    @pdf.text "INFORMAÇÕES DO CLIENTE", size: 11, style: :bold
    @pdf.move_down 5
  ...
  def add_equipment_info
    ...
    @pdf.text "INFORMAÇÕES DO EQUIPAMENTO", size: 11, style: :bold
    @pdf.move_down 5
  ...
  def add_technician_info
    @pdf.text "TÉCNICO RESPONSÁVEL", size: 11, style: :bold
    @pdf.move_down 5
  ...
  def add_parts_table
    @pdf.text "PEÇAS UTILIZADAS", size: 11, style: :bold
    @pdf.move_down 5
  ...
  def add_financial_summary
    @pdf.text "RESUMO FINANCEIRO", size: 11, style: :bold
    @pdf.move_down 5
    ...
    data << [
      ...
      { content: format_currency(@service_order.total_value || 0), font_style: :bold, size: 11 }
    ]
  ...
  def add_description
    @pdf.text "DESCRIÇÃO DO SERVIÇO", size: 11, style: :bold
    @pdf.move_down 5

    @pdf.text @service_order.description, align: :justify, leading: 3, size: 9

    if @service_order.notes.present?
      @pdf.move_down 8
      @pdf.text "OBSERVAÇÕES:", size: 10, style: :bold
      @pdf.move_down 3
      @pdf.text @service_order.notes, align: :justify, leading: 3, size: 9
    end
  ...
  def add_footer
    ...
    @pdf.bounding_box([signature_start, @pdf.cursor], width: signature_width) do
      @pdf.text "Assinatura do Cliente", align: :center, size: 9
    end
